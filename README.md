...
Step 2) Open a new terminal window and run the Seeder.py class (python3 Seeder.py)
Step 3) Select a file to upload from the UI the pops up which shows existing files in the current directory
Step 4) Open a new terminal window and run Leecher.py (python3 Leecher.py)
